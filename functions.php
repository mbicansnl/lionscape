...
function svg_icon(string $name): string
{
    $icons = [
        ...
        'ads' => '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 7.2C4 5.99 4.99 5 6.2 5h8.5L20 8.1V17.8c0 1.21-.99 2.2-2.2 2.2H6.2A2.2 2.2 0 0 1 4 17.8V7.2Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/><path d="M9 9.8h5.7M9 13h4.8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M14.7 5.2V8h2.8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M7.2 16.6a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0Zm11.8-1.1a1.6 1.6 0 0 1-3.2 0 1.6 1.6 0 0 1 3.2 0Z" fill="currentColor" opacity="0.75"/></svg>',
